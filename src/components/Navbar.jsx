    ...
    return (
        ...
        <header className="md:pb-0 bg-zinc-800/85 shadow sticky top-0 z-49">
            ...
            <nav className="flex backdrop-blur-sm items-center justify-between px-8 md:px-10 py-6 w-400 max-w-[95%] m-auto font-[montserrat]">
                ...
                <div className="w-5 h-5 relative flex items-center justify-center cursor-pointer" onClick={() => setIsOpen(prev => !prev)} aria-label="Toggle mobile navbar.">
                ...
                <div className="gap-16 hidden lg:flex">
                        ...
                        <Link to="/favorites" aria-label="Favorites page.">
                        ...
                        { signedInOrNot ? (
                            <div>
                                <button aria-label="Sign out." onClick={() => signOut(auth)} className="text-md min-h-8 font-mono text-white font-bold uppercase cursor-pointer hover:scale-105 active:scale-100 duration-300">Sign Out</button>
                            </div>
                        ) :
