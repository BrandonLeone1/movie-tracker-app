                ...
                moviesToRender.map((movie) => (
                    ...
                    <div key={movie.imdbID} className="flex flex-col gap-3 text-center h-120 min-w-0">
                        ...
                        <img src={movie.Poster} 
                            ...
                            className="h-80 w-[50%] md:w-[70%] rounded-2xl block m-auto" alt="Poster of movie."/>
                        
                            </Link>
                        <button onClick={() => handleClick(movie)} className="text-md min-h-8 bg-zinc-400 mt-2 px-4 place-self-center text-white py-1 font-bold rounded cursor-pointer hover:bg-zinc-600 transition-all duration-300 active:scale-95" aria-label="Add movie to favorites list.">Add to favorites</button>
                    </div>
